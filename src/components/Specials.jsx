...
const Specials = () => {
  return (
    <section className="mt-20 h-screen" id="menu">
      ...
      <div role="group" className="w-10/12 h-[75%] mx-auto flex mt-10 gap-6">
        <article className="w-1/3 flex flex-col items-center justify-between bg-[#EDEFEE]">
          ...
          <p className="max-w-full px-2 text-[#333333]">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorum
            sed quam harum aliquid nam assumenda?
          </p>
          <button className="self-start px-5 py-2 bg-[#F4CE14] font-semibold rounded-lg">
            Order a delivery
          </button>
        </article>
        <article className="w-1/3 flex flex-col items-center justify-between bg-[#EDEFEE]">
          ...
          <header className="w-full flex justify-between px-2">
            <h4 className="font-semibold">Bruchetta</h4>
            <span
        ...
        <article className="w-1/3 flex flex-col items-center justify-between bg-[#EDEFEE]">
          ...
          <header className="w-full flex justify-between px-2">
            <h4 className="font-semibold">Lemon Dessert</h4>
